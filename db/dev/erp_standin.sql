-- Development-only ERP stand-in data for local and CI smoke tests.
-- This is intentionally simple and designed to support the first commit checks.
...
INSERT INTO vendors (vendor_id, name, currency, status)
VALUES
...
INSERT INTO purchase_orders (po_number, vendor_id, currency, status)
VALUES
...
INSERT INTO sku_master (sku, description, uom, list_price, currency, active)
VALUES
...
INSERT INTO po_line_items (po_number, line_number, sku, description, quantity, unit_price)
VALUES
